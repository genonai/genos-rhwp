...
fn suppress_hanging_list_leading_spaces(
    text: &str,
    indent: f64,
    line_idx: usize,
    start_line: usize,
...
impl LayoutEngine {
    ...
    pub(crate) fn layout_composed_paragraph(
        ...
        for line_idx in start_line..end {
            ...
            // genos: 플로팅 그림 영역(float exclusion pads)을 가용폭에서 차감 (cab80e00)
            ...
            let mut est_x = effective_margin_left + line_cs_offset + float_left_pad + inline_offset;
